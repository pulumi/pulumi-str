...
namespace Pulumi.Str
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Str.version.txt");
    ...
    internal sealed class StrResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public StrResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
