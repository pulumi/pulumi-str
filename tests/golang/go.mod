module github.com/pulumi/pulumi-str/tests/golang

go 1.19

replace github.com/pulumi/pulumi-str/sdk => ../../sdk

require (
	github.com/pulumi/pulumi-str/sdk v0.0.0-00010101000000-000000000000
